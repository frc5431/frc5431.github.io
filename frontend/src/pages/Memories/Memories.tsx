...
const Memories: React.FC = () => {
      ...
      2017: {
        ...
        memoryImages: [
          ...
          },
          {
            ...
            caption:
              "A photo of our 2017 members who competed during this year",
          },
          {
      ...
      2018: {
        ...
        memoryImages: [
          ...
          },
          {
            ...
            caption:
              "A photo of our 2018 members who competed during this year",
          },
          {
      ...
      2019: {
        ...
        memoryImages: [
          ...
          },
          {
            ...
            caption:
              "A photo of our 2019 members who competed during this year",
          },
          {
      ...
      2022: {
        ...
        memoryImages: [
          ...
          },
          {
            ...
            caption:
              "A photo of our 2022 members who competed during this year",
          },
          {
        ...
        memoryImages: [
          {
            ...
            caption:
              "A photo of our 2023 members who competed during this year",
          },
          {
  ...
  const preloadImages = useCallback(
    (selectedYear: number): Promise<void> => {
      return new Promise((resolve, reject) => {
        ...
        const onImageError = (url: string) => {
          ...
          if (errorCount > maxErrors) {
            reject(
              new Error(
                `Too many images failed to load (${errorCount}/${totalImages})`,
              ),
            );
            return;
          }
