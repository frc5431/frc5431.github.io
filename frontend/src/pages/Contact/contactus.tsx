  ...
  return (<>
    <section id="contactus-banner" style={{ background: 'transparent' }}>
      ...
      <div id="banner-text">
        ...
        <h3 className="subtext-contactus">Any questions? Email titanrobotics@pisd.edu or fill out the form below!</h3>
      </div>
    </section>
        ...
        <div className="cards-contactus">
          <div className="card-findus">
            ...
            <address>
              ...
              <p style={{ marginBottom: '0.3rem', color: '#1DAFEA'}}>Phone: 972-905-8169</p>
              <p style={{ marginBottom: '0.3rem'}}><a href="mailto:titanrobotics@pisd.edu" target='_blank' rel="noreferrer">Email: titanrobotics@pisd.edu</a></p>
              <p style={{ marginBottom: '0.3rem'}}><a href="mailto:contactus@frc5431.com" target='_blank' rel="noreferrer">Email: contactus@frc5431.com</a></p>
