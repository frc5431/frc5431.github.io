  ...
  return (
    <main className="main" aria-labelledby="ourteam-content">
      ...
      <section className="ourteam-description">
        ...
        <p>
          Titan Robotics is a FIRST Robotics Competition Team. Each year since
          2015 we have strived to promote the values of FIRST, support our
          community, and build robots. Our team is composed of sub-teams
      ...
      <section className="subteams-content">
        <div className="subteams-container">
          ...
          <dl className="subteams-grid">
            {subteams.map((subteam) => (
              <article key={subteam.id} className="subteam-card">
                ...
                <div className="subteam-content">
                  <dt className="subteam-name">{subteam.name}</dt>
                  <dd className="subteam-description">{subteam.description}</dd>
                </div>
              </article>
            ))}
          </dl>
